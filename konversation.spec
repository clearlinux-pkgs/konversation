...
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/konversation-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/konversation-24.05.0.tar.xz.sig
...
%setup -q -n konversation-24.05.0
cd %{_builddir}/konversation-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716591065
mkdir -p clr-build
pushd clr-build
