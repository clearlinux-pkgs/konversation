...
Version  : 24.08.0
Release  : 17
URL      : https://download.kde.org/stable/release-service/24.08.0/src/konversation-24.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/konversation-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/konversation-24.08.0.tar.xz.sig
...
%setup -q -n konversation-24.08.0
cd %{_builddir}/konversation-24.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724665697
mkdir -p clr-build
pushd clr-build
