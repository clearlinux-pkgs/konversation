...
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/konversation-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/konversation-24.05.2.tar.xz.sig
...
%setup -q -n konversation-24.05.2
cd %{_builddir}/konversation-24.05.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720631785
mkdir -p clr-build
pushd clr-build
